...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit jenis tagihan</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <form class="form-horizontal" method="POST" action="{{route('editjenis',['id' => $data->id])}}">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="tarif" value="{{$data->tarif}}" onkeypress="return hanyaAngka(event)"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-1">
                        <input type="text" class="form-control" name="jatuh_tempo" value="{{$data->jatuh_tempo}}">
                      </div>
                      <div class="col-sm-1">
                        setiap bulan
                      </div>
